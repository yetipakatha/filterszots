...
if len(API_HASH) == 0:
    ...
    exit()
BOT_TOKEN = environ.get('BOT_TOKEN', '7505385904:AAHfuyOArZIHD7Uyn9HywFCLALBqcT6H_g4')
if len(BOT_TOKEN) == 0:
...
# Bot Admins
ADMINS = environ.get('ADMINS', '5184216071 961156494')
if len(ADMINS) == 0:
...
URL = environ.get("URL", "https://t.me/+5edW3asRiYc1ZjU1")
if len(URL) == 0:
